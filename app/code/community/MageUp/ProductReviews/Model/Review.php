 ...
 */
class MageUp_ProductReviews_Model_Review extends Mage_Core_Model_Abstract
{
     ...
     * @param string $type
     * @return MageUp_ProductReviews_Model_Review
     */
    public function thumbs($reviewId, $type)
    {
        /** @var $voteModel MageUp_ProductReviews_Model_Vote */
    ...
    public function getCountThumbs($reviewId, $type = null, $forUser = false)
    {
        ...
        $voteModel = Mage::getModel('productreviews/vote');
        $typeCode = $voteModel->getThumbCode($type);
        /** @var $collection MageUp_ProductReviews_Model_Resource_Vote_Collection */
     ...
     *
     * @param MageUp_ProductReviews_Model_Review $review
     * @return int
     */
