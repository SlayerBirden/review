 ...
 */
class MageUp_ProductReviews_Model_Resource_Review_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
        parent::_beforeLoad();
        $thumbsUp = MageUp_ProductReviews_Model_Vote::THUMBS_UP;
        $thumbDown = MageUp_ProductReviews_Model_Vote::THUMB_DOWN;
