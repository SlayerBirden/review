 ...
 */
class MageUp_ProductReviews_ProductController extends Mage_Core_Controller_Front_Action
{
    ...
    public function thumbsAction()
    {
        ...
        /** @var $review MageUp_ProductReviews_Model_Review */
        $review = Mage::getModel('productreviews/review');
        try {
    ...
    /**
     * @return MageUp_ProductReviews_Model_Captcha_Recaptcha
     */
    ...
    public function showParentAction()
    {
        ...
        try{
            /** @var $parent MageUp_ProductReviews_Model_Review */
            ...
            if ($parent->getStatusId() != MageUp_ProductReviews_Model_Review::STATUS_APPROVED) {
                $return->setError(1);
            ...
            /** @var $ratingModel MageUp_ProductReviews_Model_Rating */
