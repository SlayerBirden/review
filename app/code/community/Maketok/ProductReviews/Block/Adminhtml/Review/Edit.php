 ...
 */
class Maketok_ProductReviews_Block_Adminhtml_Review_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        if ($review && $review->getStatusId() == Maketok_ProductReviews_Model_Review::STATUS_PENDING) {
        ...
        if ($review && $review->getStatusId() != Maketok_ProductReviews_Model_Review::STATUS_APPROVED) {
