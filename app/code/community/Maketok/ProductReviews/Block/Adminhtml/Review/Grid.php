 ...
 */
class Maketok_ProductReviews_Block_Adminhtml_Review_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
...
//        $this->setSaveParametersInSession(true);
     ...
     *
     * @return Maketok_ProductReviews_Block_Adminhtml_Review_Grid
     */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status_id', array(
            ...
            'type'      => 'options',
            'options'   => array(
                Maketok_ProductReviews_Model_Review::STATUS_PENDING => Mage::helper('productreviews')->__('Pending'),
                Maketok_ProductReviews_Model_Review::STATUS_APPROVED => Mage::helper('productreviews')->__('Approved'),
                Maketok_ProductReviews_Model_Review::STATUS_DECLINED => Mage::helper('productreviews')->__('Declined'),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $statuses = array(
            array('label'=>'', 'value'=>''),
            array('label'=>Mage::helper('productreviews')->__('Pending'), 'value'=>Maketok_ProductReviews_Model_Review::STATUS_PENDING),
            array('label'=>Mage::helper('productreviews')->__('Approved'), 'value'=>Maketok_ProductReviews_Model_Review::STATUS_APPROVED),
            array('label'=>Mage::helper('productreviews')->__('Declined'), 'value'=>Maketok_ProductReviews_Model_Review::STATUS_DECLINED),
        );
    ...
    public function decorateStatus($value, $row)
    {
        ...
        switch ($row->getStatusId()) {
            case Maketok_ProductReviews_Model_Review::STATUS_APPROVED :
                $class = 'grid-severity-notice';
                break;
            case Maketok_ProductReviews_Model_Review::STATUS_PENDING :
                $class = 'grid-severity-major';
                break;
            case Maketok_ProductReviews_Model_Review::STATUS_DECLINED :
