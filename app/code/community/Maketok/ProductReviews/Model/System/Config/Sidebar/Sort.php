 ...
 */
class Maketok_ProductReviews_Model_System_Config_Sidebar_Sort
{
    /**
     * Options getter
     *
    ...
    {
        return array(
            array('value' => 0, 'label' => Mage::helper('productreviews')->__('Random')),
            array('value' => 1, 'label' => Mage::helper('productreviews')->__('Latest')),
            array('value' => 2, 'label' => Mage::helper('productreviews')->__('Most Popular')),
        );
    }
}