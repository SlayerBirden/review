 ...
 */
class Maketok_ProductReviews_Model_System_Config_Sidebar
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => 1, 'label' => Mage::helper('productreviews')->__('Left Column only')),
            array('value' => 2, 'label' => Mage::helper('productreviews')->__('Right Column only')),
            array('value' => 3, 'label' => Mage::helper('productreviews')->__('Both Columns')),
        );
    }
}